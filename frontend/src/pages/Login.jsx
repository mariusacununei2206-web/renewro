  ...
  return (
    <div style={styles.pagina}>
      <div style={styles.card}>
        ...
        <h2 style={styles.titlu}>Bine ai venit pe RenewRO!</h2>
        <p style={styles.subtitlu}>Pentru a continua, te rugăm să te conectezi.</p>
        ...
        <p style={styles.link}>
          Nu ai cont?{' '}
          <Link to="/register" style={styles.linkText}>Înregistrează-te!</Link>
        </p>
      </div>
    </div>
  )
